...
class Test_Scale_Entire(BaseTest):
    """
    Testcases for Scale Entire model
    """
    
    def test_scale_entire_normal(self):
        ...
        self.main_page.scale_entire(file, scale_pct=200, processing_time=10)
