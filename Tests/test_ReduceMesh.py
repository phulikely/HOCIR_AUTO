...
class Test_Reduce_Mesh(BaseTest):
    """
    Testcases for reduce mesh by percent
    """

    def test_reduce_mesh_normal(self):
        ...
        self.main_page.reduce_mesh(file, pct=50, processing_time=5)
