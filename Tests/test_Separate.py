import time
import os
from Config.config import ElementSeparate, TestData
...
class Test_Separate(BaseTest):
    """
    Testcases for Separate
    """
    ...
    def test_separate(self):
        ...
        self.main_page.separate(file, point1_x, point1_y, point2_x, point2_y, point3_x, point3_y, processing_time=10)
