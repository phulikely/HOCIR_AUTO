...
class Test_Create_RWB(BaseTest):
    """
    Testcases for creating RWB file
    """

    def test_create_rwb_normal(self):
        ...
        self.main_page.create_rwb(file, point1_x, point1_y, point2_x, point2_y, point3_x, point3_y, processing_time=5)
