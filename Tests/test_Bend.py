...
class Test_Bend(BaseTest):
    """
    Testcases for Bend an area of object
    """

    def test_bend_area_normal(self):
        ...
        self.main_page.bend(file, start_x, start_y, tgt_x, tgt_y, new_pos_x=0.05, processing_time=10)
